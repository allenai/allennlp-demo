...
export class ModuleInfo {
    constructor(
        ...
        public defaultMinAttn: number = DEFAULT_MIN_ATTN
    ) {}
     ...
     */
    static findInfoByName(name: string): ModuleInfo | undefined {
...
const allModules = [
    ...
    new ModuleInfo('count', 'count(P) → C', 'Count the number of input passage spans.'),
    new ModuleInfo(
        'compare-num-lt',
    ...
    new ModuleInfo('span', 'span(P) → S', 'Identify a contiguous span from the attended tokens.'),
    new ModuleInfo(
        'compare-date-lt',
