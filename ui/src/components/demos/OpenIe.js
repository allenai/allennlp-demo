...
const description = (
    <span>
        <p>
            ...
            These extractions break syntactically complex sentences into the relationships they
            express, which can then be used for various downstream tasks.
        </p>
        <p>
            This page demonstrates a reimplementation of{' '}
            <a
                href="https://www.semanticscholar.org/paper/Supervised-Open-Information-Extraction-Stanovsky-Michael/c82921a426fd8090564f459b0bd90cdb1e7a9e2d"
                target="_blank"
                rel="noopener noreferrer">
                {' '}
                a deep BiLSTM sequence prediction model (Stanovsky et al., 2018)
            </a>
            .
        </p>
    </span>
...
const bashCommand = `echo '{"sentence": "John decided to run for office next month."}' | \\
...
function toHierplaneTrees(response) {
    ...
    const trees = response.verbs.map(({ tags }) => {
