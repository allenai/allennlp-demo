...
const description = (
    <span>
        Textual Entailment (TE) is the task of predicting whether, for a pair of sentences, the
        facts in the first sentence necessarily imply the facts in the second. This task is in some
        sense "NLP-complete", and you should not expect any current model to cover every possible
        aspect of entailment. Instead, you should think about what the model was trained on to see
        whether it could reasonably capture the phenomena that you are querying it with.
    </span>
);
...
const taskModels = [
    {
        ...
        desc: (
            <span>
                The{' '}
                <a href="https://www.semanticscholar.org/paper/A-Decomposable-Attention-Model-for-Natural-Languag-Parikh-T%C3%A4ckstr%C3%B6m/07a9478e87a8304fc3267fa16e83e9f3bbd98b27">
                    decomposable attention model (Parikh et al, 2017)
                </a>{' '}
                combined with <a href="https://arxiv.org/abs/1802.05365">ELMo embeddings</a> trained
                on SNLI.
            </span>
        ),
        modelId: 'elmo-snli',
    ...
    },
    {
        ...
        desc: (
            <span>
                The{' '}
                <a href="https://www.semanticscholar.org/paper/RoBERTa%3A-A-Robustly-Optimized-BERT-Pretraining-Liu-Ott/077f8329a7b6fa3b7c877a57b81eb6c18b5f87de">
                ...
                <p>
                    <b>Contributed by:</b>{' '}
                    <a
                        href="https://zhaofengwu.github.io"
                        target="_blank"
    ...
    },
    {
        ...
        desc: (
            <span>
                ...
                trained on{' '}
                <a href="https://www.nyu.edu/projects/bowman/multinli/paper.pdf">MultiNLI</a>.
                <p>
                    <b>Contributed by:</b>{' '}
                    <a
                        href="https://zhaofengwu.github.io"
  ...
  */
    ...
    if (attackData && 'input_reduction' in attackData) {
        ...
        reducedInput = {
            ...
            context: (
                <p>
                    <strong>Premise:</strong> {requestData.premise}
                </p>
            ),
...
const Output = ({
    ...
    const accordion = modelIsRoberta ? null : (
        <>
            <MySaliencyMaps
            ...
            <OutputField label="Attention">
                <Collapse>
                    <Collapse.Panel header="Premise to Hypothesis Attention">
                        <p>
                            For every premise word, the model computes an attention over the
                            hypothesis words. This heatmap shows that attention, which is normalized
                            for every row in the matrix.
                        </p>
                        <HeatMap
                            colLabels={premise_tokens}
                            rowLabels={hypothesis_tokens}
                            data={h2p_attention}
                        />
                    </Collapse.Panel>
                    <Collapse.Panel header="Hypothesis to Premise Attention">
                        <p>
                            For every hypothesis word, the model computes an attention over the
                            premise words. This heatmap shows that attention, which is normalized
                            for every row in the matrix.
                        </p>
                        <HeatMap
                            colLabels={hypothesis_tokens}
                            rowLabels={premise_tokens}
                            data={p2h_attention}
                        />
                    </Collapse.Panel>
                </Collapse>
    ...
    return (
        <div className="model__content answer">
            <OutputField label="Summary">{summaryText}</OutputField>
