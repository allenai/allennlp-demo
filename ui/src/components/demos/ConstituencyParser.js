...
const description = (
    <span>
        <p>
            ...
            Non-terminals in the parse tree are types of phrases, the terminals are the words in the
            sentence.
        </p>
        <p>
            This demo is an implementation of a minimal neural model for constituency parsing based
            on an independent scoring of labels and spans described in{' '}
            <a href="http://arxiv.org/abs/1805.06556">
                Extending a Parser to Distant Domains Using a Few Dozen Partially Annotated Examples
                (Joshi et al, 2018)
            </a>
            . <br />
            This model uses <a href="https://arxiv.org/abs/1802.05365">ELMo embeddings</a>, which
            are completely character based and improves single model performance from 92.6 F1 to
...
const defaultUsage = {
    ...
    evaluationNote: (
        <span>
            The constituency parser was evaluated on the Penn Tree Bank dataset. Unfortunately we
