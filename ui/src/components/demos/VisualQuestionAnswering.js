...
const description = (
    <span>
        ...
        model for learning task-agnostic joint representations of image content and natural
        language.
    </span>
);

const modelUrl =
    'https://storage.googleapis.com/allennlp-public-models/vilbert-vqa-2020.10.01.tar.gz';

const bashCommand = `echo '{"question": "What game are they playing?", "image": "https://storage.googleapis.com/allennlp-public-data/vqav2/baseball.jpg" }' | \\
...
const modelProps = {
    ...
    disablePermalinksForModel: true,
};
