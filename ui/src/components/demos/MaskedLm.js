...
Enter text with one or more "[MASK]" tokens and the model will generate the most likely substitution for each.  Note that the default example demonstrates how BERT demonstrates gender bias, in that it thinks the doctor is more likely a man ("his")
