...
const description = (
    <span>
        <span>
            Named Entity Recognition is the task of identifying named entities (people, locations,
            organizations, etc.) in the input text.
        </span>
    </span>
);
...
const taskModels = [
    {
        ...
        desc: (
            <span>
                This model is the baseline model described in{' '}
                <a href="https://www.semanticscholar.org/paper/Semi-supervised-sequence-tagging-with-bidirectiona-Peters-Ammar/73e59cb556351961d1bdd4ab68cbbefc5662a9fc">
                    Peters, Ammar, Bhagavatula, and Power 2017
                </a>
                . It uses a Gated Recurrent Unit (GRU) character encoder as well as a GRU phrase
                encoder, and it starts with pretrained{' '}
                <a href="https://nlp.stanford.edu/projects/glove/">GloVe vectors</a> for its token
                embeddings. It was trained on the{' '}
                <a href="https://www.clips.uantwerpen.be/conll2003/ner/">CoNLL-2003</a> NER dataset.
            </span>
        ),
    ...
    },
    {
        ...
        desc: (
            <span>
                This Model identifies a broad range of 16 semantic types in the input text. This
                model is a reimplementation of{' '}
                <a href="https://arxiv.org/abs/1603.01360">Lample (2016)</a> and uses a biLSTM with
                a CRF layer, character embeddings and ELMo embeddings. It was trained on the
                Ontonotes 5.0 dataset, and has dev set F1 of 88.2.
            </span>
        ),
