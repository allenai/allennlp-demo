...
class Model extends React.Component {
    ...
    render() {
        ...
        if (subModel) {
            const selectedSubModel = subModel.options.filter(
                (o) => o.modelId === (this.state.selectedSubModel || subModel.options[0].modelId)
            );
                    ...
                    <div className="model__content">
                        ...
                        {subModel ? (
                            <FormField>
                                ...
                                <FormSelect
                                    value={
                                        this.state.selectedSubModel || subModel.options[0].modelId
                                    }
