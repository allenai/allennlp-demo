...
export const Usage = (
    usage // usage: {installNote?: Element, installCommand?: string, bashNote?: Element, bashCommand?: string, pythonNote?: Element, pythonCommand?: string, predictorNote?: Element, predictorCommand?: string, evaluationNote?: Element, evaluationCommand?: string}
) => (
    <React.Fragment>
        <UsageSection>
